...
public class CandyCrush {
    public static int[][] candyCrush(int[][] board) {
        ...
        return isSteady ? board : candyCrush(board);
    }

    public static void main(String[] args) {
        int[][] output = CandyCrush.candyCrush(new int[][]{
                {110, 5, 112, 113, 114},
                {210, 211, 5, 213, 214},
                {310, 311, 3, 313, 314},
                {410, 411, 412, 5, 414},
                ...
                {1, 1, 2, 2, 2},
                {4, 1, 4, 4, 1014}});
        System.out.println(Arrays.stream(output).map(a -> Arrays.stream(a).mapToObj(String::valueOf).collect(Collectors.joining(","))).collect(Collectors.joining("\n")));
    }
